    ...
    <section id="contact" className="py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          ...
          <p className="text-center text-charcoal/60 -mt-8 mb-4 max-w-xl mx-auto text-lg">
            {dict.contact.subtitle}
          </p>
          {/* Trust micro-copy */}
          <div className="flex items-center justify-center gap-6 mb-14 text-sm text-charcoal/40">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-globe-50 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 text-globe-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-coffee-50 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 text-coffee-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-fresh-50 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 text-fresh-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
